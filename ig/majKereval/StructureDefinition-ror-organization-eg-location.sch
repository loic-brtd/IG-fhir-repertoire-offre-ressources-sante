...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'RORCommuneCog']) &gt;= 1">extension with URL = 'RORCommuneCog': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'RORCommuneCog']) &lt;= 1">extension with URL = 'RORCommuneCog': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'careOf']) &lt;= 1">extension with URL = 'careOf': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'additionalLocator']) &lt;= 1">extension with URL = 'additionalLocator': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'houseNumber']) &lt;= 1">extension with URL = 'houseNumber': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'buildingNumberSuffix']) &lt;= 1">extension with URL = 'buildingNumberSuffix': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'RORTelecomConfidentialityLevel']) &gt;= 1">extension with URL = 'RORTelecomConfidentialityLevel': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'RORTelecomConfidentialityLevel']) &lt;= 1">extension with URL = 'RORTelecomConfidentialityLevel': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'RORTelecomUsage']) &lt;= 1">extension with URL = 'RORTelecomUsage': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'RORTelecomCommunicationChannel']) &gt;= 1">extension with URL = 'RORTelecomCommunicationChannel': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'RORTelecomCommunicationChannel']) &lt;= 1">extension with URL = 'RORTelecomCommunicationChannel': maximum cardinality of 'extension' is 1</sch:assert>
