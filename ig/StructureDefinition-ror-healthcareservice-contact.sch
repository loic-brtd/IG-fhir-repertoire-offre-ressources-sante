...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'nom']) &lt;= 1">extension with URL = 'nom': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'natureContact']) &lt;= 1">extension with URL = 'natureContact': maximum cardinality of 'extension' is 1</sch:assert>
